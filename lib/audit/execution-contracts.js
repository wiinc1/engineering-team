...
function evaluateExecutionContractDispatchReadiness({ contract = null, verificationReport = null } = {}) {
  if (!contract) {
    return {
      policy_version: VERIFICATION_REPORT_SKELETON_POLICY_VERSION,
  ...
  return {
    policy_version: VERIFICATION_REPORT_SKELETON_POLICY_VERSION,
    skeletonRequired,
    canDispatch: !skeletonRequired || hasSkeleton,
    missingRequiredArtifacts: skeletonRequired && !hasSkeleton ? ['verification_report_skeleton'] : [],
