...
function createAuditApiServer(options = {}) {
  ...
  const server = http.createServer(async (req, res) => {
    ...
    try {
      ...
      if (!summaryMatch && !resourceMatch && !assignmentMatch && !lockMatch && !skillEscalationMatch && !checkInsMatch && !retierMatch && !reassignmentMatch && !sreMonitoringMatch && !pmBusinessContextMatch && !closeReviewCancellationMatch && !closeReviewExceptionalDisputeMatch && !closeReviewHumanDecisionMatch && !closeReviewBacktrackMatch && !architectHandoffMatch && !engineerSubmissionMatch && !orchestrationMatch && !workflowThreadsMatch && !workflowThreadActionMatch && !qaResultsMatch && !reviewQuestionsMatch && !reviewQuestionActionMatch) throw createHttpError(404, 'not_found', 'Route not found');
