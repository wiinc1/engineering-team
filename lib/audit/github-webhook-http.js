...
const { handleGitHubWebhookRequest } = require('./github-webhook-handler');
...
function createGitHubWebhookRouteWrapper(bundle, options = {}, helpers = {}) {
  ...
  server.on('request', async (req, res) => {
    ...
    try {
      if (typeof createIntakeDraft !== 'function') {
        throw httpError(501, 'not_supported', 'GitHub intake draft creation is not wired for this server.');
      }
