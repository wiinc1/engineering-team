const ROLE_PERMISSIONS = Object.freeze({
  ...
  admin: ['history:read', 'state:read', 'relationships:read', 'observability:read', 'agents:read', 'agents:write', 'agent-delegation:write', 'agent-role-requests:write', 'events:write', 'assignment:write', 'projections:rebuild', 'metrics:read', 'tasks:create', 'projects:write', 'forge:read'],
