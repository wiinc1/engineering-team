const ROLE_PERMISSIONS = Object.freeze({
  ...
  pm: ['history:read', 'state:read', 'relationships:read', 'observability:read', 'agents:read', 'agents:write', 'assignment:write', 'metrics:read', 'tasks:create', 'projects:write'],
  ...
  admin: ['history:read', 'state:read', 'relationships:read', 'observability:read', 'agents:read', 'agents:write', 'events:write', 'assignment:write', 'projections:rebuild', 'metrics:read', 'tasks:create', 'projects:write'],
