...
const STAGES = {
  ...
  // Post Execution Contract approval, pre-implementation dispatch (factory proof path).
  READY: 'READY',
...
const VALID_TRANSITIONS = {
  ...
  [STAGES.BACKLOG]: [STAGES.ARCHITECT_REVIEW, STAGES.TODO, STAGES.IN_PROGRESS, STAGES.READY],
  [STAGES.TODO]: [STAGES.BACKLOG, STAGES.ARCHITECT_REVIEW, STAGES.IN_PROGRESS],
  [STAGES.ARCHITECT_REVIEW]: [STAGES.TECHNICAL_SPEC],
  [STAGES.TECHNICAL_SPEC]: [STAGES.IMPLEMENTATION, STAGES.IN_PROGRESS, STAGES.READY],
  [STAGES.READY]: [STAGES.IMPLEMENTATION, STAGES.IN_PROGRESS],
