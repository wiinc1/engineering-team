...
const { DEFAULT_DELIVERY_DIR, DEFAULT_FACTORY_QUEUE_LEASE_SECONDS, normalizeRequirement, evidencePathForItem, makeForgeTaskId } = require('./factory-delivery-shared');
const {
...
const DEFAULT_QUEUE_LEASE_SECONDS = DEFAULT_FACTORY_QUEUE_LEASE_SECONDS;
