 ...
 * Required: postgres, api, selected specialist runtime, workers heartbeat.
 * OpenClaw HTTP health is required only when SPECIALIST_RUNTIME_PROVIDER=openclaw.
...
async function collectHealthReport({
  ...
  const [
    ...
    probeSpecialistRuntimeProvider(provider, {
      env,
