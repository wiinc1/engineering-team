...
function resolveStagingRuntime(options = {}) {
  ...
  return {
    ...
    gitlabWebhookSecret: options.gitlabWebhookSecret
      || process.env.STAGING_GITLAB_WEBHOOK_SECRET
      || process.env.GITLAB_WEBHOOK_SECRET
      || process.env.GITHUB_WEBHOOK_SECRET
      || 'golden-path-local-webhook-secret',
    forgeIntakeProvider: options.forgeIntakeProvider
      || options.intakeProvider
      || process.env.FORGE_INTAKE_PROVIDER
      || process.env.STAGING_FORGE_INTAKE_PROVIDER
      || 'gitlab',
