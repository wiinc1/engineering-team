...
function evidenceModeOptions(config, item = {}) {
  ...
  // GitLab #274: trusted Simple close requires real PR/merge evidence, but it is
  // deliberately distinct from hosted release evidence. The latter is only
  // enabled by explicit real-delivery intent or configuration.
