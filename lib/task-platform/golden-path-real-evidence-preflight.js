...
function isExplicitFixtureProofProfile(options = {}, env = process.env) {
...
function isRealEvidenceMode(options = {}, env = process.env) {
  // Explicit non-claim fixture smoke is never treated as production-like real evidence.
  if (isExplicitFixtureProofProfile(options, env)) return false;
