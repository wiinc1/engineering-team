...
const { approveExecutionContractWithRetry, recordGoldenPathHumanReview } = require('./golden-path-phase1-contract');
const {
...
async function runGoldenPathPhase1(options = {}) {
  ...
  await recordGoldenPathHumanReview({ ctx, options, contractBody, taskId, api, apiSend, runProjectionCatchUp });
  ...
  api.projectionPostApproval = api.approveContract.projectionPostApproval;
