...
const DEFAULT_FACTORY_QUEUE_LEASE_SECONDS = 60 * 60;
...
function resolveFactoryQueueConfig(options = {}) {
  ...
  return {
    ...
    factoryQueueLeaseSeconds: positiveIntegerConfig(
      options, 'factoryQueueLeaseSeconds', 'FACTORY_QUEUE_LEASE_SECONDS', DEFAULT_FACTORY_QUEUE_LEASE_SECONDS,
    ),
...
module.exports = {
  DEFAULT_QUEUE_PATH, DEFAULT_DELIVERY_DIR, DEFAULT_FACTORY_QUEUE_LEASE_SECONDS,
