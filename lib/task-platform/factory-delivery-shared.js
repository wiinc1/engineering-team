...
function resolveFactoryConfig(options = {}) {
  ...
  return {
    ...
    ...realEvidenceConfig,
    agentDrivenPhase1: options.agentDrivenPhase1 === true || realEvidenceConfig.agentDrivenPhases || parseBooleanEnv(process.env.FF_FACTORY_AGENT_DRIVEN_PHASE1, false),
