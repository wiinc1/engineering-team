...
function resolveFactoryConfig(options = {}) {
  ...
  return {
    ...
    skipForgeSeed: options.skipForgeSeed === true, releaseEnv: options.releaseEnv || process.env.RELEASE_ENV || null, changeKind: options.changeKind || process.env.CHANGE_KIND || null,
