...
function buildEvidence(options) {
  return {
    ...
    deployment: {
      id: options.deploymentId || process.env.DEPLOYMENT_ID || process.env.FACTORY_DEPLOYMENT_ID || null,
      commitSha: options.commitSha || process.env.GIT_COMMIT_SHA || process.env.FACTORY_GIT_COMMIT_SHA || null,
