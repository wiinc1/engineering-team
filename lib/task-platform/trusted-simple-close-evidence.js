...
/**
 * Factory/orchestrator option helper: enable trusted Simple PR/merge proof.
 * Hosted release evidence remains an independent, explicitly selected mode.
 */
function applyTrustedSimpleCloseOptions(options = {}, env = process.env) {
  ...
  return {
    ...
    requireRealEvidence: options.requireRealEvidence === true,
    collectRealEvidence: options.collectRealEvidence === true,
