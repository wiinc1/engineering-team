...
async function runGoldenPathPhase2(ctx, evidence, options = {}) {
  ...
  const persistDir = ctx.persistDir || evidence.phase1?.persistDir || evidence.phase0?.persistDir || evidence.phase0?.localBaseDir;
...
async function runGoldenPathPhases(options = {}) {
  ...
  const ctx = {
    ...
    persistDir: options.persistDir || evidence.phase1?.persistDir || evidence.phase0?.persistDir || evidence.phase0?.localBaseDir,
  };
