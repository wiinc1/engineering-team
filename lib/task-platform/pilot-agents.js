const DEFAULT_PILOT_AGENT_ROLES = Object.freeze(['pm', 'architect', 'engineer', 'qa', 'sre', 'ux']);
...
const DEFAULT_PILOT_AGENTS = Object.freeze([
  ...
  {
    agentId: 'ux',
    displayName: 'Pilot UX Designer',
    role: 'ux',
    description: 'Pilot UX agent for workflow, accessibility, and task-detail trust signals.',
  },
]);
