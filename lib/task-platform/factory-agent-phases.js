...
function buildImplementerPrompt({
  ...
  const executionRules = trusted ? [
    'Use your filesystem, shell, git, and GitHub tools to implement the approved requirement now.',
    'Do not switch branches or edit the primary checkout. Create an isolated git worktree from the current origin/main revision and work only there.',
