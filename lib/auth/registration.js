...
function buildRegistrationPolicy(options = {}) {
  const runtimeEnv = options.runtimeEnv || process.env.FACTORY_RUNTIME_ENV || process.env.NODE_ENV || 'development';
  const production = runtimeEnv === 'production' || process.env.NODE_ENV === 'production';
