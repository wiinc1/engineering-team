...
- Vercel additionally exposes explicit `api/v1/tasks/[taskId].js`, `api/v1/tasks/[taskId]/[action].js`, and `api/v1/projects/[...route].js` handlers so the versioned task-platform and Projects routes do not depend on nested catch-all matching quirks.
