...
- Full isolated Docker/PostgreSQL integration: 25/25 pass in 22.315 seconds across audit, registration, delivery queue, Graphile/job runtime, and all nine LangGraph live acceptance/recovery tests; teardown left no issue container, volume, network, or port listener.
