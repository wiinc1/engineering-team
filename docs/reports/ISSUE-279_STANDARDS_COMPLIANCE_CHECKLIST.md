...
- Gap observed: Mobile layout is out of scope for issue #279; browser CI still exercises mobile projects with updated baselines only where route chrome changed.
...
- Docs updated: `docs/design/assets/command-console-redesign-target.png`; `scripts/reseed-issue-279-local.js`; `docs/reports/ISSUE-279_STANDARDS_COMPLIANCE_CHECKLIST.md`.