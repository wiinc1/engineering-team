...
const UNIT_TEST_FILES = [
  ...
  'tests/unit/job-runtime-contracts.test.js',
  'tests/unit/job-runtime-artifacts.test.js',
  'tests/unit/job-runtime-infrastructure.test.js',
  'tests/unit/job-runtime-worker.test.js',
  'tests/unit/langgraph-runtime.test.js',
  'tests/unit/langgraph-runtime-branches.test.js',
  'tests/unit/langgraph-fencing.test.js',
  'tests/unit/langgraph-equivalence.test.js',
  'tests/unit/langgraph-registry.test.js',
  'tests/unit/langgraph-mutation-contracts.test.js',
  'tests/unit/langgraph-production-ports.test.js',
  'tests/unit/job-runtime-port-handlers.test.js',
