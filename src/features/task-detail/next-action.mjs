...
function pmAction(role, signals) {
  ...
  return {
    ...
    primaryAction: signals.pmRefinementStatus?.value === 'Requested/pending' ? 'retry_pm_refinement' : null,
    primaryHref: signals.pmRefinementStatus?.value === 'Requested/pending' ? null : '#task-detail-overview-section',
    primaryLabel: signals.pmRefinementStatus?.value === 'Requested/pending' ? 'Retry PM refinement' : 'Review PM context',
