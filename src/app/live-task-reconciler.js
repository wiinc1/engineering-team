...
export function compareLiveUpdateVersions(current, incoming) {
...
export function permissionSafeMerge(existing = {}, patch = {}) {
  const clean = {};
...
export function reconcileLiveUpdates(current = {}, updates = []) {
  const accepted = [];
  const ignored = [];
